package net.minebr.database.datasource;

import net.minebr.MiningMain;
import net.minebr.database.datamanager.GenericDataManager;
...
public class SQLiteDataSource extends AbstractDataSource {
    ...
    private void openConnection() throws DatabaseException {
        try {
            ...
            this.connection = DriverManager.getConnection("jdbc:sqlite:" + MiningMain.getPlugin().getDataFolder().getPath() + "/database.db");
